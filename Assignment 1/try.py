...
def inverse(equation):
    ...
    if '~' not in list:
        list.insert(0,'~')
        list.insert(4,'~')
        print(print_list(list), "this is the inverse of the given equation: ")
...
def converse(equation):
    ...
    if '~' not in list:
        ...
        list[0] = list[3]
        list[3] = var
        print(print_list(list), "this is the converse of the given equation: ")
...
def contrapositive(equation):
    ...
    if '~' not in list:
        ...
        list[1] = list[5]
        list[5] = var
        print(print_list(list), "this is the contrapositive of the given equation: ")
